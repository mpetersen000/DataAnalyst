...
setwd("/Users/michellepetersen/Downloads/eda-course-materials/lesson6")
...
with(subset(dat, carat > .5 & carat < 1.8), sd(m5.residuals))
dat$resid <- as.numeric(dat$m5.residuals)
ggplot(aes(y = resid, x = round(carat, 2)), data = dat) +
  geom_line(stat = "summary", fun.y = sd)


thisDiamond = data.frame(carat = 1.8, cut = "V.Good",
                         color = "I", clarity="VS1")
